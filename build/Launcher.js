...
class Launcher extends events_1.EventEmitter {
    ...
    getLaunchOptions(optionsOverride = {}) {
        const baseOptions = {
            url: null,
            authenticator: null,
            timeout: 10000,
    ...
    async start() {
        ...
        try {
            ...
            let argumentsLogs = gameArguments.join(' ');
            ...
            const minecraftProc = (0, child_process_1.spawn)(java, gameArguments, { cwd: logs, detached: this.options.detached });
